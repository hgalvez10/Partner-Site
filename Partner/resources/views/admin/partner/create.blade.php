...
<section class="content">
  ...
  <div class="box box-success">
    <div class="box-header with-border">
      <h3 class="box-title">Registrar Partner</h3>
    </div>
    <form method="POST" role="form" action="/partner">
      {{ csrf_field() }}
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
      ...
      <div class="box-footer">
        ...
        <button type="submit" class="btn btn-success btn-flat pull-right">Registrar Partner</button>
      </div>
    </form>
  </div>
</section>
